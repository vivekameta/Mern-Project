                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Product Name</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Edit Product name"/>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Product Price</label>
                        <input type="number" class="form-control" id="exampleInputUsername1" placeholder="Edit Product Price"/>
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Categories</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Sub-categories</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Product Rating</label>
                        <input type="number" class="form-control" id="exampleInputUsername1" placeholder="Edit Product Rating"/>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Descripation</label>
                        <textarea  class="form-control"
                        id="exampleInputUsername1" placeholder="Edit Product Descripation"
                         ></textarea>
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Edit Product Image</label>
                        <input type="file" class="form-control" id="exampleInputUsername1" placeholder="Product Descripation"/>
                      </div>
