...
function Categories() {
  ...
  const handlecat = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:6099/Categories/addcat", {categories},);
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" onSubmit={handlecat}>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Categories</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="categories" onChange={(e)=>setCategory(e.target.value)}/>
                      </div>
