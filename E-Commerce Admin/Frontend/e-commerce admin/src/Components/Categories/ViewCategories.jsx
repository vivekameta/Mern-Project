  ...
  const deleteProduct = async (id) => {
    try {
      const response = await axios.delete(
        `http://localhost:6099/Categories/deletecat?id=${id}`
      );
      ...
      alert(
        error.response?.data?.msg || "Failed to delete category. Please try again."
      );
    }
  };
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> ViewCategories </h3>
            ...
            <table className="table text-center">
              ...
              <tbody>
                {data.map((el,i) => {
                 return <tr key={i}>
                    <td>{i+1}</td>
                    <td>{el.categoriesId.categories}</td>
                    ...
                    <td>
                      ...
                      <button type="button" className="btn btn-danger m-1" onClick={() => deleteProduct(el._id)}>
                        Delete
                      </button>
                    </td>
                  </tr>
